...
1. **Irvin, J., et al.** (2019). CheXpert: A large chest radiograph dataset with uncertainty labels and expert comparison. [Link](https://arxiv.org/abs/1901.07031)
2. **Dogan, R. I., et al.** (2014). NCBI disease corpus: A resource for disease name recognition and concept normalization. [Link](https://doi.org/10.1016/j.jbi.2013.12.006)
3. **Lee, J., et al.** (2020). BioBERT: A pre-trained biomedical language representation model for biomedical text mining. [Link](https://doi.org/10.1093/bioinformatics/btz682)
4. **Li, J., et al.** (2016). BioCreative V CDR task corpus. [Link](https://doi.org/10.1093/database/baw068)
5. **Nori, H., et al.** (2023). Capabilities of GPT-4 on medical challenge problems. [Link](https://arxiv.org/abs/2303.13375)
6. **Wang, Z., et al.** (2022). Formulating few-shot fine-tuning towards language model pre-training. [Link](https://doi.org/10.18653/v1/2022.findings-emnlp.233)
7. **Wei, J., et al.** (2022). Chain-of-thought prompting elicits reasoning in large language models. [Link](https://arxiv.org/abs/2201.11903)
</details>
